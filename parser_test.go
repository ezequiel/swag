...
func TestParseTypeOverrides(t *testing.T) {
	...
	p := New(SetOverrides(map[string]string{
		"github.com/ezequiel/swag/testdata/global_override/types.Application":  "string",
		"github.com/ezequiel/swag/testdata/global_override/types.Application2": "github.com/ezequiel/swag/testdata/global_override/othertypes.Application",
		"github.com/ezequiel/swag/testdata/global_override/types.ShouldSkip":   "",
	}))
	err := p.ParseAPI(searchDir, mainAPIFile, defaultParseDepth)
	assert.NoError(t, err)
...
func TestParser_skipPackageByPrefix(t *testing.T) {
	...
	assert.False(t, parser.skipPackageByPrefix("github.com/ezequiel/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/ezequiel/swag/cmd"))
	assert.False(t, parser.skipPackageByPrefix("github.com/ezequiel/swag/gen"))

	parser = New(SetPackagePrefix("github.com/ezequiel/swag/cmd"))

	assert.True(t, parser.skipPackageByPrefix("github.com/ezequiel/swag"))
	assert.False(t, parser.skipPackageByPrefix("github.com/ezequiel/swag/cmd"))
	assert.True(t, parser.skipPackageByPrefix("github.com/ezequiel/swag/gen"))

	parser = New(SetPackagePrefix("github.com/ezequiel/swag/cmd,github.com/ezequiel/swag/gen"))
